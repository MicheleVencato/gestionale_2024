...
def inserisci_cliente():
    ...
    if st.button("Aggiungi Cliente"):
        ...
        global clienti_df
        clienti_df = clienti_df.append(nuovo_cliente, ignore_index=True)
...
def inserisci_fornitore():
    ...
    if st.button("Aggiungi Fornitore"):
        ...
        global fornitori_df
        fornitori_df = fornitori_df.append(nuovo_fornitore, ignore_index=True)
...
def inserisci_prodotto():
    ...
    if st.button("Aggiungi Prodotto"):
        ...
        global prodotti_df
        prodotti_df = prodotti_df.append(nuovo_prodotto, ignore_index=True)
...
def inserisci_ordine():
    ...
    if st.button("Aggiungi Ordine"):
        ...
        global ordini_df
        ordini_df = ordini_df.append(nuovo_ordine, ignore_index=True)
...
def inserisci_fattura():
    ...
    if st.button("Aggiungi Fattura"):
        ...
        global fatture_df
        fatture_df = fatture_df.append(nuova_fattura, ignore_index=True)
