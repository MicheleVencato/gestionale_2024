...
# Funzione per inserire nuovi ordini con tutte le colonne del foglio originale
def inserisci_ordine():
    ...
    fornitore_selezionato = st.selectbox("Seleziona Fornitore", fornitori_df['Nome Fornitore'])
    quantita = st.number_input("Quantità", min_value=0, format="%d")
...
# Funzione per inserire nuove fatture con tutte le colonne del foglio originale
